...
- **Patterns:** the skill currently defines **32 numbered Chinese AI-writing patterns**. If you add, remove, rename, or renumber any pattern, update:
  - the README pattern tables,
  - the “32 类中文 AI 写作痕迹” wording,
